...
public class List_Vehicles {
    ...
    @Test
    public void TC_01_List_Vehicles_successfully_English_And_Arabic() {
        ...
        Add_Vehicle_Body.put("vehicle_vin_number", VinNumberGenerator.Vin_Number_Generator_17);
        ...
        // ****************  List_Vehicles  ******************* :
        // ****************  List_Vehicles  English ******************* :


        String List_Vehicles_URL = "v1/companies/"+Company_ID+"/vehicles";  // List_Vehicles_URL

        Response List_Vehicles_Response_English = apiobject.buildNewRequest(List_Vehicles_URL , RestActions.RequestType.GET)
        ...
        // ****************  List_Vehicles Arabic ******************* :

        Response List_Vehicles_Response_Arabic = apiobject.buildNewRequest(List_Vehicles_URL , RestActions.RequestType.GET)
        ...
        Validations.assertThat().response(List_Vehicles_Response_Arabic)
                .extractedJsonValue("message")
                .contains("تم إسترجاع العربات بنجاح")
                .perform();


        long TimeOut = List_Vehicles_Response_English.getTimeIn(TimeUnit.MILLISECONDS);
    ...
    @Description("Check : \"Limit must be numeric\",\n" +
    ...
    @Test
    public void TC_02_check_List_Vehicles_Fail_English() {
        Response List_Vehicles_Response_English = list_vehicles_main.List_Vehicles_Fail_English();
    ...
    @Test
    @Description("check :   \"التحديد يجب أن يكون رقم\",\n" +
    ...
    public void TC_03_check_List_Vehicles_Fail_Arabic() {
        Response List_Vehicles_Response_English = list_vehicles_main.List_Vehicles_Fail_Arabic();
