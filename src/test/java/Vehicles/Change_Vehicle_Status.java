...
public class Change_Vehicle_Status {
    ...
    @Test
    public void TC_01_Change_Vehicle_Status_Successfully_English_And_Arabic(){
        ...
        Add_Vehicle_Body.put("vehicle_vin_number", VinNumberGenerator.Vin_Number_Generator_23);
        ...
        String Change_Vehicle_Status_URL = "v1/companies/"+Company_ID+"/vehicles/changeStatus/"+Vehicle_id;   // Change Vehicle Status URL


        JSONObject Change_Vehicle_Status_Body = new JSONObject();
        Change_Vehicle_Status_Body.put("status_id",2);

        Response Change_Vehicle_Status_Response_English = apiobject.buildNewRequest(Change_Vehicle_Status_URL , RestActions.RequestType.PUT)
        ...
        long TimeOut = Change_Vehicle_Status_Response_English.getTimeIn(TimeUnit.MILLISECONDS);
    ...
    @Test
    public void TC_02_Check_Change_Vehicle_Status_Fail_English_And_Arabic(){

        Response Change_Vehicle_Status_Response_English = change_vehicle_status_main.Change_Vehicle_Status_Fail_English(
                "Test");
        ...
        Response Change_Vehicle_Status_Response_Arabic = change_vehicle_status_main.Change_Vehicle_Status_Fail_Arabic(
                "Test");

        Validations.assertThat().response(Change_Vehicle_Status_Response_Arabic)
                .extractedJsonValue("errors")
        ...
        long TimeOut = Change_Vehicle_Status_Response_Arabic.getTimeIn(TimeUnit.MILLISECONDS);
        Validations.assertThat()
                .number(TimeOut)
                .isLessThanOrEquals(Main_Variables.timOut)
                .withCustomReportMessage("Validate Response Time")
