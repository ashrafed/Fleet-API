...
public class Get_Order_Status_Details {
    ...
    private Get_Order_Status_Details_Main get_order_status_details_main;
    ...
    public void Beforclase(){
        ...
        get_order_status_details_main = new Get_Order_Status_Details_Main(apiobject);
    ...
    @Test
    public void TC_01_Get_Order_Status_Details_Succ_English_And_Arabic(){
        ...
        Add_Vehicle_Body.put("vehicle_vin_number", VinNumberGenerator.Vin_Number_Generator_7);
        ...
        // ***************  Get_Order_Status_Details_response_English  ********************** :

        String Get_Order_Status_Details_URL = "v1/companies/"+Company_ID+"/orders/"+Order_ID+"/status/details";  // Get_Order_Status_Details_URL

        Response Get_Order_Status_Details_response_English =  apiobject.buildNewRequest(Get_Order_Status_Details_URL , RestActions.RequestType.GET)
                .setContentType(ContentType.JSON)
                .addHeader("platform","@vb~sD~KS#2>]pq")
                .addHeader("Accept","application/json")
                .addHeader("Accept-Language","en")
        ...
        Validations.assertThat().response(Get_Order_Status_Details_response_English)
                .extractedJsonValue("message")
                .contains("Order status details retrieved successfully")
                .perform();


        // ***************  Get_Order_Status_Details_response_Arabic  ********************** :

        Response Get_Order_Status_Details_response_Arabic =   apiobject.buildNewRequest(Get_Order_Status_Details_URL , RestActions.RequestType.GET)
                .setContentType(ContentType.JSON)
                .addHeader("platform","@vb~sD~KS#2>]pq")
                .addHeader("Accept","application/json")
        ...
        Validations.assertThat().response(Get_Order_Status_Details_response_Arabic)
                .extractedJsonValue("message")
                .contains("تم استرجاع تفاصيل الحالات بنجاح")
                .perform();
    }
}
