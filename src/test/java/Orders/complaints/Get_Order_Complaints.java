...
public class Get_Order_Complaints {
    ...
    private Create_Order_Complaint_Main create_order_complaint_main;

    private Get_Order_Complaints_Main get_order_complaints_main;
...
//
        ...
        create_order_complaint_main = new Create_Order_Complaint_Main(apiobject);

        get_order_complaints_main = new Get_Order_Complaints_Main(apiobject);
    ...
    @Test
    @Link("https://carefer.atlassian.net/browse/CP-6396")
    @Issue("https://carefer.atlassian.net/browse/CP-6396")
    public void TC_1_Get_Order_Complaint_Successfully() {
        ...
        Add_Vehicle_Body.put("vehicle_vin_number", VinNumberGenerator.Vin_Number_Generator_16);
        ...
        //*****************   Creat Order Complaints :  *************************    :



        String Creat_Order_Complaints_URL = "v1/companies/"+ Company_ID+ "/orders/"+ Order_ID+ "/complaints";
      ...
      Response Creat_Order_Complaints_Response = apiobject.buildNewRequest(Creat_Order_Complaints_URL, RestActions.RequestType.POST)
                .setContentType(ContentType.JSON)
                .addHeader("platform", "@vb~sD~KS#2>]pq")
                .addHeader("Accept", "application/json")
                .addHeader("Accept-Language", "en")
      ...
      String Order_Complaint_ID = Creat_Order_Complaints_Response.jsonPath().get("data.complaint_no");


        //*****************  Get Order Complaints :  *************************    :


        String Get_Order_Complaints_URL = "v1/companies/"+Company_ID+"/orders/"+Order_ID+"/complaints";   // Get Order Complaints URL

        Response Get_Order_Complaints_response = apiobject.buildNewRequest(Get_Order_Complaints_URL, RestActions.RequestType.GET)
                .setContentType(ContentType.JSON)
                .addHeader("platform", "@vb~sD~KS#2>]pq")
                .addHeader("Accept", "application/json")
                .addHeader("Accept-Language", "en")
        ...
        Validations.assertThat().response(Get_Order_Complaints_response)
                .extractedJsonValue("message")
                .contains("Complaints retrieved successfully")
                .perform();
