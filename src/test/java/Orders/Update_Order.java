...
public class Update_Order {
    ...
    private Update_Order_Main update_order_main;
    ...
    public void Beforclase() {
        ...
        update_order_main = new Update_Order_Main(apiobject);
    ...
    @Test
    public void TC_01_Update_Order_Successfully(){
        ...
        Add_Vehicle_Body.put("vehicle_vin_number", VinNumberGenerator.Vin_Number_Generator_19);
