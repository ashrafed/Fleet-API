...
public class TCF_06_Login_CreatCompany_CreateDriver_CreateVehicle_CreateOrder_GetOrders_ChangeVehicleDriver_CreateDriver_UpdateVehicleInfo {
    ...
    public void TCF_05_Login_CreatCompany_CreateDriver_CreateVehicle_CreateOrder_GetOrders_ChangeVehicleStatus(){
        ...
        Add_Vehicle_Body.put("vehicle_vin_number", VinNumberGenerator.Vin_Number_Generator_4);
        ...
        Create_Order_Body.put("vehicle_id", Vehicle_ID); // vehicle_id
        ...
        String Get_Vehicle_Details_URL = "v1/companies/" + Company_ID + "/vehicles/" + Vehicle_ID;
